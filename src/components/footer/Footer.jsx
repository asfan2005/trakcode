          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 md:gap-8 w-full md:w-3/4">
            ...
            <div className="ml-0 md:ml-4">
              ...
              <ul className="space-y-2 md:space-y-3">
                <li><a href="/" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.company.links.home')}</a></li>
                <li><a href="/features" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.company.links.features')}</a></li>
                <li><a href="/store" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.company.links.store')}</a></li>
                <li><a href="/partnership" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.company.links.partnership')}</a></li>
                <li><a href="/contact" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.company.links.contact')}</a></li>
              </ul>
            </div>
            ...
            <div className="ml-0 md:ml-4">
              ...
              <ul className="space-y-2 md:space-y-3">
                <li><a href="/download" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.resource.links.download')}</a></li>
                <li><a href="/manuals" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.resource.links.manuals')}</a></li>
              </ul>
            </div>
            ...
            <div className="ml-0 md:ml-4">
              ...
              <ul className="space-y-2 md:space-y-3">
                <li><a href="/terms" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.legal.links.terms')}</a></li>
                <li><a href="/privacy" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.legal.links.privacy')}</a></li>
                <li><a href="/returns" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.legal.links.returns')}</a></li>
                <li><a href="/warranty" className="text-sm md:text-base text-[#475467] hover:text-blue-600">{t('footerSection.columns.legal.links.warranty')}</a></li>
              </ul>
            </div>
