        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          >
            ...
            <button
              onClick={() =>
                handleDownload(
                  "https://play.google.com/store/apps/details?id=app.usfast.eld"
                )
              }
          ...
          >
            ...
            <button
              onClick={() =>
                handleDownload(
                  "https://apps.apple.com/gb/app/usfast-eld/id6499588161"
                )
              }
          ...
          >
            ...
            <button
              onClick={() =>
                handleDownload("https://www.usfasteld.com/sticker.pdf")
              }
          ...
          >
            ...
            <button
              onClick={() =>
                handleDownload("https://www.usfasteld.com/Certificate.pdf")
              }
          ...
          >
            ...
            <button
              onClick={() =>
                handleDownload("https://www.usfasteld.com/dot.pdf")
              }
          ...
          >
            ...
            <button
              onClick={() =>
                handleDownload("https://www.usfasteld.com/usfastelduser.pdf")
              }
